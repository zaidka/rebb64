...
;-------------------------------------------------------------------------------
; Character set ($4000-$47FF, 2048 bytes)
;-------------------------------------------------------------------------------
        .segment "CHARSET"
...
;-------------------------------------------------------------------------------
        .segment "LEVELS2"
        .incbin "../data/level-data-part2.bin"
...
;-------------------------------------------------------------------------------
; Music frequency tables ($F39C-$F4BB, 288 bytes)
; Labels defined for relocatable access from sound-engine.s
;-------------------------------------------------------------------------------
        .segment "MUSICFREQS"

        .incbin "../data/music-freqs.bin", 0, $1D

FREQ_TABLE_LO:
        .incbin "../data/music-freqs.bin", $1D, $7C - $1D

FREQ_TABLE_HI:
        .incbin "../data/music-freqs.bin", $7C

;-------------------------------------------------------------------------------
; SFX and music data ($F922-$FDFF, 1246 bytes)
;-------------------------------------------------------------------------------
        .segment "SFXMUSIC"
